      ...
      <div className="container-xl">
        <AnimatedSection>
          <SectionHeader
            ...
            title="Explore Every Corner of Mauritius"
            description="Our expert local guides reveal the island's most spectacular landscapes, cultural treasures and hidden gems."
          />
        </AnimatedSection>

        <AnimatedSection delay={0.1}>
          <HomeSectionCarousel viewAllHref="/tours" viewAllLabel="View All Tours">
            {TOURS.map((tour) => (
              <div
                key={tour.id}
              ...
              >
                ...
                <div className="p-5">
                  ...
                  <h3 className="font-heading font-bold text-navy text-xl mb-2">{tour.name}</h3>
                  ...
                  <div className="flex gap-2">
                    ...
                    <WhatsAppButton service={tour.name} size="sm" label="Book" />
                  </div>
                </div>
              </div>
            ))}
