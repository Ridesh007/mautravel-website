    ...
    <section className="section-padding bg-white">
      <div className="container-xl">
        ...
        <AnimatedSection delay={0.1}>
          <HomeSectionCarousel viewAllHref="/activities" viewAllLabel={t("viewAll")}>
            {ACTIVITIES.map((activity) => {
              const text = tItems.raw(activity.id) as ActivityText;
              return (
                <div
                  key={activity.id}
                ...
                >
                  ...
                  <div className="absolute inset-0 flex flex-col justify-end p-4">
                    ...
                    <div className="max-h-0 overflow-hidden group-hover:max-h-48 transition-all duration-300">
                      ...
                      <WhatsAppButton service={text.name} size="sm" label={t("bookNow")} className="relative z-20 w-full justify-center" />
                    </div>
                  </div>
                </div>
              );
